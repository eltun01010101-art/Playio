    ...
    <main className="min-h-screen bg-zinc-950 text-white">
      <section className="mx-auto flex min-h-[85vh] max-w-6xl flex-col justify-center px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:gap-4">
          <Link
            href="/register"
            className="rounded-lg bg-violet-600 px-6 py-3 text-center font-bold transition hover:bg-violet-700"
          >
            Başla
          </Link>
          ...
          <Link
            href="/tournaments"
            className="rounded-lg border border-zinc-700 px-6 py-3 text-center font-bold transition hover:bg-zinc-900"
          >
            Turnirlərə bax
          </Link>
        </div>
